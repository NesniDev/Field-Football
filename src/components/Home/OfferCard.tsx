...
export const OfferCard = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-4xl mb-10 mx-5">
      ...
      <div className="relative z-10 flex flex-col justify-center px-5 py-20">
        <h2 className="text-2xl md:text-6xl uppercase font-extrabold text-center italic text-black">
          Sé el primero en <span className="text-btn-dark">enterarte</span>
        </h2>

        <p className="text-sm text-black/40 my-5 mx-auto text-center">
        ...
        >
          <input
            ...
            className="w-56 md:w-96 px-5 py-3 bg-black/5 border border-black/10 rounded-full placeholder:text-black/40 text-black focus:outline-none focus:ring-1 focus:ring-lime-400/40"
          />
