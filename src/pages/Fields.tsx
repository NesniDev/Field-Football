    ...
    return (
        <>
            <div className="max-w-5xl container mx-auto">
                ...
                <form className="mx-5 md:mx-auto relative flex justify-center font-orbitron items-center transition-all duration-300 max-w-lg gap-3 mt-8 bg-gray-400/40  rounded-lg px-4 py-2 group focus-within:ring-2 focus-within:ring-offset-green-200 focus-within:ring-offset-2 focus-within:ring-green-600" onSubmit={handleSubmit}> 
